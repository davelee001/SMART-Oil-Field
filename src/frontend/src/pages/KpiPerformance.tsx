...
const emptySummary: KpiSummary = { frameworks: 0, activeIndicators: 0, openPeriods: 0, overduePeriods: 0, reportingRate: 0, portfolioScore: 0, onTrack: 0, atRisk: 0, offTrack: 0, notReported: 0 };
...
const KpiPerformance: React.FC = () => {
    ...
    return <Box sx={{ width: '100%' }}>
        ...
        {(summary.overduePeriods > 0 || summary.notReported > 0) && <Alert severity="warning" sx={{ mb: 2 }}>{summary.overduePeriods} overdue reporting period(s) and {summary.notReported} active KPI(s) without a verified result require attention.</Alert>}
